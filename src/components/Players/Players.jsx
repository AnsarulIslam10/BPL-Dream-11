          ...
          <div key={player.playerId} className="card bg-base-100 shadow-xl">
            ...
            <div className="card-body">
              ...
              <div className="flex items-center justify-between pb-2 border-b-2">
                ...
                <h3 className="px-4 py-2 bg-gray-200 rounded-xl">
                  {player.role}
                </h3>
              </div>
              <div>
                <h3 className="font-semibold mb-3">
                  Rating:{" "}
                  <span className="text-yellow-500">{player.rating}</span>
                </h3>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button
                    ...
                    className="btn btn-outline font-normal border-gray-200"
                  >
                    Choose Player
                  </button>
                </div>
...
Players.propTypes = {
  AddSelectedPlayer: PropTypes.func,
};
